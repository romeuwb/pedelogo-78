-- Schema PedeLogo adaptado para PostgreSQL local (sem auth.users do Supabase)
-- Para análise e desenvolvimento local
...
-- 3) Tabela de usuários (simulando auth.users do Supabase)
...
-- 3.1 Perfis (associa users -> perfil com role)
